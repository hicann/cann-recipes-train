...
2. 源码准备。
   ...
   # 添加镜像中已经准备好的依赖文件
   cp -r /workspace/verl/verl ./cann-recipes-train/rl_train/deepseek/
   cp -r /workspace/vllm/vllm ./cann-recipes-train/rl_train/deepseek/
   cp -r /workspace/vllm-ascend/vllm_ascend ./cann-recipes-train/rl_train/deepseek/
   cp -r /workspace/Megatron-LM/megatron ./cann-recipes-train/rl_train/deepseek/
   cp -r /workspace/MindSpeed/mindspeed ./cann-recipes-train/rl_train/deepseek/
   cp -r /workspace/MindSpeed-LLM/mindspeed_llm ./cann-recipes-train/rl_train/deepseek/
   cd ./cann-recipes-train/rl_train/deepseek/   # 回到本样例目录
...
4. 下载依赖的开源框架代码。
   ...
   cp -r verl ../cann-recipes-train/rl_train/deepseek/
   cd ..
   ...
   cd vllm
   git checkout v0.9.1
   cp -r vllm ../cann-recipes-train/rl_train/deepseek/
   cd ..
   ...
   cp -r megatron ../cann-recipes-train/rl_train/deepseek/
   cd ..

# Adapted from
# https://gitcode.com/ascend/MindSpeed-RL/blob/2.1.0/mindspeed_rl/config_cls/megatron_config.py
...
from verl_patches.train_engine.base_config import BaseConfig


class MegatronConfig(BaseConfig):
    '''
    Model configuration class. From Mindspeed-RL.
    ...
    lr_warmup_iters: Numbers of iterations to warmup (default: 0)
    ...
    fix_router: fix MoE router for load balancing. (default: False)
    ...
    moe_router_bias_update_rate: expert bias update rate in the aux-loss-free load balancing strategy (default: 0.001)
    moe_aux_loss_coeff: scaling coefficient for the aux loss (default: 0.001)
    gemm_gradient_accumulation_fusion: use gradient-accumulation-fusion in gemm (default: False)
    use_fused_mlp: use fused mlp (default: False)
    '''
    ...
    def __init__(self, training_config: Dict, model_config: Dict):
        ...
        self.moe_router_bias_update_rate = 0.001
        self.moe_aux_loss_coeff = 0.001
        self.gemm_gradient_accumulation_fusion = False
        self.use_fused_mlp = False
        self.async_log_allreduce = False
        self.dualpipev_dw_detach = False
        self.mla_swap_core_attn_out = False
        self.mla_up_proj_tp_overlap = False
        self.moe_unperm2_mem_optim = False
        self.mtp_loss_scale = 0.1
        self.recompute_mla_up_proj = False
        self.unaligned_linear = False
        self.use_cp_send_recv_overlap = False
        self.context_parallel_algo = 'megatron_cp_algo'
        self.use_fused_ring_attention_update = False
        self.cp_window_size = 1

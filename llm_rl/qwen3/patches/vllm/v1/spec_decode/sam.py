# -*- coding: utf-8 -*-
# Copied from the implementation of the work SAM Decoding: Speculative Decoding via Suffix Automaton
# (https://github.com/hyx1999/SAM-Decoding/blob/main/samd_sam_only/sam/dyn_sam.py).
# Copyright Yuxuan Hu et al., 2024. All rights reserved.

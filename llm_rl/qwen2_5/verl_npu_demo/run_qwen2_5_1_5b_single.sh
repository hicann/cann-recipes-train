...
export ASCEND_RT_VISIBLE_DEVICES=0          # specify certain devices in the environment for use
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2_5_1_5b_math_single' \
    trainer.n_gpus_per_node=1 \
    trainer.nnodes=1 \
    trainer.save_freq=70 \
    trainer.test_freq=10 \
    trainer.total_epochs=5 \
    trainer.device=npu 2>&1 | tee ./run_log/qwen2_5_1_5b_math_single.log

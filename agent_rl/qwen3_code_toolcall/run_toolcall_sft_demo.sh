...
export ASCEND_RT_VISIBLE_DEVICES=0,1,2,3,4,5,6,7    # specify certain devices in the environment for use
...
project_name=code_toolcall_sft
experiment_name=multiturn-toolcall-sft-qwen-3-1b

TRAIN_DATA=toolcall_sft.parquet
EVAL_DATA=toolcall_sft.parquet
...
torchrun --nnodes=$nnodes \
    ...
    use_remove_padding=true 2>&1 | tee log/sft_run_log/multiturn-toolcall-sft-qwen-3-1b.log

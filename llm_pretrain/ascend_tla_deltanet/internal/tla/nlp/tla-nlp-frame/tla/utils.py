...
def require_version(required_version, hint):
    """
    ...
    def decorator(fn):
        ...
        def wrapper(ctx, *args, **kwargs):
            from transformers.utils.versions import require_version as hf_require_version

            hf_require_version(required_version, hint)
...
def deprecate_kwarg(
    ...
    deprecated_version = packaging_version.parse(version)

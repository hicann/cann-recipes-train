...
from tla.modules.l2norm import l2norm_bwd, l2norm_fwd
from tla.ops.common.chunk_delta_h_mod import chunk_gated_delta_rule_bwd_dhu, chunk_gated_delta_rule_fwd_h
from tla.ops.common.chunk_o import chunk_bwd_dqkwg, chunk_bwd_dv_local, chunk_fwd_o
from tla.ops.delta_rule.wy_fast import prepare_wy_repr_bwd, prepare_wy_repr_fwd, recompute_w_u_fwd
from tla.utils import autocast_custom_bwd, autocast_custom_fwd, input_guard
...
def chunk_delta_rule_fwd(
    ...
    h, v_new, final_state = chunk_gated_delta_rule_fwd_h(  
        ...
        output_final_state=output_final_state,   #这里有值传递！！！！！！！！！！！
        cu_seqlens=cu_seqlens,
    )
...
def chunk_delta_rule_bwd(
    ...
    h, v_new, _ = chunk_gated_delta_rule_fwd_h(
        ...
        g=None,
        initial_state=initial_state,
        output_final_state=False,       #这里是False！！！！！！！！！！
        cu_seqlens=cu_seqlens,
    )
